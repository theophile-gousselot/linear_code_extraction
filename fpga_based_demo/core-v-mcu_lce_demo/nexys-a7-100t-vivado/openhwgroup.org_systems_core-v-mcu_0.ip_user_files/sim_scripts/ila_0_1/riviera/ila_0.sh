...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/theophile/these/these_theophile_gousselot/lce/fpga/demonstrator/vivado_projects/build/core-v-mcu-nexys-video_ila-instr-pc-rst_sw-lce-ap/nexys-a7-100t-vivado/openhwgroup.org_systems_core-v-mcu_0.cache/compile_simlib/riviera"
  fi
